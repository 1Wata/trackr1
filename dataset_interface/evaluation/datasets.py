...
import importlib
from evaluation.data import SequenceList

DatasetInfo = namedtuple('DatasetInfo', ['module', 'class_name', 'kwargs'])

pt = "evaluation.%sdataset"  # Useful abbreviations to reduce the clutter
...
def load_dataset(name: str, return_path: bool = False):
    ...
    if return_path:
        dataset_path = getattr(dataset, 'base_path', None)
...
# def get_dataset(return_path = False, *args):
#     """ Get a single or set of datasets."""
#     dset = SequenceList()
#     dset_path = []
#     for name in args:
#         if return_path:
#             sequences, dataset_path = load_dataset(name, return_path)
#             dset_path.append(dataset_path)

#             dset.extend(sequences)
#         else:
#             sequences = load_dataset(name, return_path)
#             dset.extend(sequences)
        
#     if return_path:
#         return dset, dset_path
#     else:
#         return dset
