...
class BaseVideoDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        self, name, root, image_loader=jpeg4py_loader_w_failsafe, return_img_path=True
    ):
        """
        args:
            ...
            image_loader (jpeg4py_loader) -  The function to read the images. jpeg4py (https://github.com/ajkxyz/jpeg4py)
                                            is used by default.
            return_img_path (bool) - Whether to return the image path in the get_frames() function.
        """
        self.name = name
        self.root = root
        self.image_loader = image_loader
        self.return_img_path = return_img_path
        self.use_first_frame_template = True
