...
from utils.utils import env_settings
...
class TrackingNet(BaseVideoDataset):
    ...
    def _load_class_info(self):
        ...
        # class_map_path = os.path.join(ltr_path, '..', 'data', 'trackingnet_classmap.txt')
    ...
    def get_frames(self, seq_id, frame_ids, anno=None, use_first_frame_template=False):
        frame_list = [self._get_frame(seq_id, f) for f in frame_ids]

        if use_first_frame_template:
            frame_list.insert(0, self._get_frame(seq_id, 0))
